...
VulkanSwapChain::VulkanSwapChain(GLFWwindow* newWindow, VkInstance vulkanInstance) {
    // Initialize your Vulkan instance, create surface, and other necessary setup
    // ...
...
VulkanSwapChain::~VulkanSwapChain() {
    ...
    // Release image views and other resources
}
...
void VulkanSwapChain::createLogicalDevice() {
...
VkPhysicalDevice VulkanSwapChain::getPhysicalDevice() const {
